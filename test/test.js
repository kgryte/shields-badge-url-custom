...
test( 'the `image` field corresponds to a shields.io badge url', function test( t ) {
	...
	t.equal( out.image, 'https://img.shields.io/badge/beep-boop-red.svg?style=flat', 'image url' );
	t.end();
});
...
test( 'a badge logo can be specified', function test( t ) {
	...
	t.equal( out.image, 'https://img.shields.io/badge/beep-boop-red.svg?style=flat&logo=data:image/png;base64,AAA', 'image url' );
	t.end();
});
...
test( 'a badge logo width can be specified', function test( t ) {
	...
	t.equal( out.image, 'https://img.shields.io/badge/beep-boop-red.svg?style=flat&logo=data:image/png;base64,AAA&logoWidth=100', 'image url' );
	t.end();
});
...
test( 'the badge style can be specified', function test( t ) {
	...
	t.equal( out.image, 'https://img.shields.io/badge/beep-boop-red.svg?style=flat-square', 'image url' );
	t.end();
});
...
test( 'the badge format can be specified', function test( t ) {
	...
	t.equal( out.image, 'https://img.shields.io/badge/beep-boop-red.png?style=flat', 'image url' );
	t.end();
});
...
test( 'badge parameters (label, status, color) are checked for dashes and underscores and escaped', function test( t ) {
	...
	t.equal( out.image, 'https://img.shields.io/badge/be__ep-b--oo--p-re__d.svg?style=flat', 'image url' );
	t.end();
});
