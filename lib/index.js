...
var IMAGE = 'https://img.shields.io/badge/{{label}}-{{status}}-{{color}}.{{format}}?style={{style}}{{#logo}}&logo={{{logo}}}{{/logo}}{{#width}}&logoWidth={{width}}{{/width}}&link={{{llink}}}&link={{{rlink}}}';
...
function urls( options ) {
	...
	opts.llink = opts.llink || '#';
	opts.rlink = opts.rlink || '#';
